...
- the tool description states the call behavior, durable id, runtime settlement notice, follow-up through `dsh_send_message`, and the explicit foreground override;
