        ...
        await persistence.append(m.id, [
          ...
          { type: 'assistant/message', seq: 8, time: 9, data: {
            ...
            message: createMessage({
              role: 'assistant',
              content: [
                { type: 'tool-call', id: CallId('call-x'), name: 'dsh_bash', arguments: '{}' },
              ],
              source: {
                kind: 'model',
                ...{ provider: 'mock', model: 'mock' },
        ...
        await persistence.append(m.id, [
          ...
          { type: 'assistant/message', seq: 2, time: 3, data: {
            ...
            message: createMessage({
              role: 'assistant',
              content: [
                { type: 'tool-call', id: CallId('call-risk'), name: 'dsh_write', arguments: '{}' },
              ],
              source: {
                kind: 'model',
                ...{ provider: 'mock', model: 'mock' },
          ...
          { type: 'tool/call', seq: 3, time: 4, data: { turn: 1, step: 1, callId: CallId('call-risk'), name: 'dsh_write', arguments: '{}' } },
        ])
