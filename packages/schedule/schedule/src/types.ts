...
/** Canonical `dsh_schedule_create` value. */
export type ScheduleCreateValue = ScheduleView | ScheduleToolError

/** Canonical `dsh_schedule_list` value. */
export type ScheduleListValue = ScheduleView[] | ScheduleToolError

/** Successful `dsh_schedule_delete` value, including the non-mutating not-found result. */
...
/** Canonical `dsh_schedule_delete` value. */
