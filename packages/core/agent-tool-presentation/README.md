...
The row an [agent preset](../../preset/agent-presets/README.md) carries to say which form of its tools the model sees: `native` (every schema), `code` (only `dsh_run_code` plus a generated TypeScript SDK), or `both`.
