  ...
  describe('{{fromRequest:...}} substitution', () => {
    ...
    function scriptedCall(argumentsDelta: string): StreamChunk[] {
      return [
        ...
        { type: 'tool-call-delta', index: 0, id: CallId('c1'), name: 'dsh_update_goal', argumentsDelta },
        { type: 'block-end', index: 0, block: { type: 'tool-call', id: CallId('c1'), name: 'dsh_update_goal', arguments: argumentsDelta } },
