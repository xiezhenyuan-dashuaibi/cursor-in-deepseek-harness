...
const PROMPT_TEXT =
  'Use dsh_session_search to find relevant work from prior sessions, or dsh_session_event_search to search earlier '
  + 'events in one session. Search results are cursor-free and workspace-scoped. Follow a useful hit with '
  + 'dsh_session_trace, dsh_session_event_trace, or dsh_session_event_read when you need lineage, relationships, or exact data.'
