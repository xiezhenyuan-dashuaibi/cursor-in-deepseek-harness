/**
 * Model-facing persistent `dsh_bash` tool over the owner-scoped PTY seam.
...
/**
 * Register the model-facing persistent `dsh_bash` tool.
...
/** Register one owner-scoped persistent `dsh_bash` tool. */
