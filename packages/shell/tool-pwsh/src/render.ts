/**
 * Model-facing result rendering for the dsh_pwsh tool — the PowerShell twin of
 ...
 * stderr section, then exit-status markers, matching the dsh_bash tool's story —
...
/**
 * Shape one background-process read into the `dsh_job_output` delta the model
