/**
 * Pure formatting and coordinate conversion for the `dsh_lsp` tool: one-based↔zero-based UTF-16 cursor
...
/**
 * UI presentation for a pending `dsh_lsp` call. Uses a generic search card; the title carries the
