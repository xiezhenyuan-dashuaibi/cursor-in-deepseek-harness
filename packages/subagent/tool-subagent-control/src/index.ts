/**
 * The globally named `dsh_send_message` and `dsh_interrupt_agent` tools: thin
...
/**
 * Register the `dsh_send_message` and `dsh_interrupt_agent` tools.
...
export function apply(ctx: Context): void {
  ctx.tools.register(defineTool({
    ...
    async execute(args, exec) {
      ...
      if (!parent) {
        ...
        throw new Error('dsh_send_message requires a calling agent (exec.agent was undefined)')
      }
  ...
  ctx.tools.register(defineTool({
    ...
    description:
      ...
      + 'queued for the agent stay parked until a later dsh_send_message, agents it started keep running, and '
    ...
    execute(args, exec) {
      ...
      if (!caller) {
        ...
        throw new Error('dsh_interrupt_agent requires a calling agent (exec.agent was undefined)')
      }
