/**
 * Model-facing `dsh_web_search` and `dsh_web_fetch` tools over `ctx.web`. This package owns schemas,
...
/**
 * Default cap on one `dsh_web_fetch` output and on source characters converted
