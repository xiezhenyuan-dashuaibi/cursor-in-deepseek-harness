// dsh_todo_write toolview: plan-flavored summary row replacing the generic
...
export const todoToolview = {
  ...
  apply(ctx: Context): void {
    ctx.slots.inject('tool.call.toolview', () =>
      ctx.slots.register({ name: 'tool.call.toolview', key: 'dsh_todo_write', locale: NS }, TodoRow))
  },
}
