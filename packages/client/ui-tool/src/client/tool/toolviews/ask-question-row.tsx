// dsh_ask_user_question toolview: question-flavored summary row replacing the
...
export function AskQuestionRow({ toolName, block, inspect, t }: AskQuestionRowProps) {
  ...
  // (apiproxy dsh_ask_user_question handler): 'ASK_CANCELLED' is the user's own
...
export const askQuestionToolview = {
  ...
  apply(ctx: Context): void {
    ctx.slots.inject('tool.call.toolview', () => ctx.slots.register({
      name: 'tool.call.toolview', key: 'dsh_ask_user_question', locale: NS,
    }, AskQuestionRow))
  },
}
