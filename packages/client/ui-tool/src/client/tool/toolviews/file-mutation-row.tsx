...
// and `dsh_write` tools. The row composes the shared ToolRow (chrome, running
...
export const fileMutationToolview = {
  ...
  apply(ctx: Context): void {
    ctx.slots.inject('tool.call.toolview', function* () {
      yield ctx.slots.register({ name: 'tool.call.toolview', key: 'dsh_edit', locale: NS }, FileMutationRow)
      yield ctx.slots.register({ name: 'tool.call.toolview', key: 'dsh_write', locale: NS }, FileMutationRow)
    })
  },
}
