// Read toolview registrant: the keyed toolview hole for the dsh_read tool. The row
...
export const readToolview = {
  ...
  apply(ctx: Context): void {
    ctx.slots.inject('tool.call.toolview', () =>
      ctx.slots.register({ name: 'tool.call.toolview', key: 'dsh_read', locale: NS }, ReadRow))
  },
}
