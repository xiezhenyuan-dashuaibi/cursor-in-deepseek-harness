 ...
 * `card:'read'` render intent the dsh_read tool declares arrives on the snapshot as
 ...
 *   be trusted to be one of the compiled variants, and the dsh_read tool's own
