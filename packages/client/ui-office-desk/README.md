...
- The painted scene stays click-through; only the organizer pad takes pointer events so conversation, cards, and Cursor remain reachable through empty board space.
