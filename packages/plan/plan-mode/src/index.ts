 ...
 * `dsh_exit_plan_mode` presents the completed plan for user review, while the
 ...
 */
export const EXIT_PLAN_MODE = 'dsh_exit_plan_mode'
    ...
    ctx.tools.register(defineTool({
      ...
      execute: async (args, exec) => {
        ...
        const answer = await interaction.ask({
          ...
          // generic channel message names dsh_ask_user_question, which the model
