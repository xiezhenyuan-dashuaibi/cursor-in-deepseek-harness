/**
 * Model-facing `dsh_str_replace_editor` over the Harness filesystem seam.
...
/** Register the model-facing `dsh_str_replace_editor` tool. */
...
/** Register one `dsh_str_replace_editor` tool over `ctx.fs`. */
