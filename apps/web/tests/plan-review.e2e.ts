...
// and the recorded turn ends on dsh_exit_plan_mode blocking against the live
...
const TASK = 'Plan a small change: add a --greeting flag to a CLI. Do not read or write any files. '
  + 'Call dsh_exit_plan_mode with a short plan of at most five bullet points. '
...
describe('web e2e: plan review takeover round trip', () => {
  ...
  it('reviews the plan on a decision card and approves through it', async () => {
    ...
    // The card takes over the input area while dsh_exit_plan_mode blocks. Its
