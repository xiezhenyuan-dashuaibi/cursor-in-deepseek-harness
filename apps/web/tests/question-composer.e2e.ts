...
// already exposes dsh_ask_user_question (the ui-user-questions row's node half mounts
...
describe('web e2e: resident question composer round trip', () => {
  ...
  it('asks through the composer, answers, and completes with the answer logged', async () => {
    ...
    // Golden of the answered transcript: the dsh_ask_user_question round trip
