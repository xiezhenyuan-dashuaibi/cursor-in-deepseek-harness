...
- button "Think The user wants me to use the dsh_ask_user_question tool with specific parameters. Let me do exactly that.":
  - img
  - img
  - text: Think The user wants me to use the dsh_ask_user_question tool with specific parameters. Let me do exactly that.
