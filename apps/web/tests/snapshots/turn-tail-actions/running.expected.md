- banner:
  ...
  - tablist:
    - tab "Chat" [selected]
    - tab "Trajectory"
- text: Begin your reply with the plain sentence "Reading the workspace now." as text, and in that same message call the dsh_bash tool with the command "echo alpha". After the tool result, reply with the single word DONE and stop. {{clock}}
- button "Copy":
  - img
- tooltip "Copy"
