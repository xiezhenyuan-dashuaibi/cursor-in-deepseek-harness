...
- button "Think The user wants me to use the dsh_workflow tool exactly once with specific parameters. Let me carefully follow the instructions:":
  - img
  - img
  - text: "Think The user wants me to use the dsh_workflow tool exactly once with specific parameters. Let me carefully follow the instructions:"
