- banner:
  - navigation "Session hierarchy":
    - button "Use dsh_web_search to search exactly" [disabled]
  - img
  - text: Standard mode
  - button "Session log":
    - text: Session log
  ...
  - tablist:
    - tab "Chat" [selected]
    - tab "Trajectory"
- text: Use dsh_web_search to search exactly "DeepSeek Harness snapshot search". Then reply exactly SEARCH_DONE and stop. {{clock}}
- button "Copy":
  - img
