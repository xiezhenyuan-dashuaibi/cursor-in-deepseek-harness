...
const PROMPT = `Begin your reply with the plain sentence "${NARRATION}" as text, and in that same message call the dsh_bash tool with the command "echo alpha". After the tool result, reply with the single word DONE and stop.`
