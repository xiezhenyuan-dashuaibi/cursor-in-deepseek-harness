...
```ts type-equiv
/** Structured local-calendar input accepted by `dsh_schedule_create`. */
...
```ts type-equiv
/** Absolute selector accepted by `dsh_schedule_create`. */
