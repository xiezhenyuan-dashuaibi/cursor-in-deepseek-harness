...
flowchart TD
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_cursor_agent["client-ui-cursor-agent"]
    ...
    pkg_client_ui_float_window["client-ui-float-window"]
    pkg_client_ui_flower_pot["client-ui-flower-pot"]
    ...
    pkg_client_ui_overlay_desktop["client-ui-overlay-desktop"]
    pkg_client_ui_overlay_shaped["client-ui-overlay-shaped"]
    ...
    pkg_client_ui_television["client-ui-television"]
  ...
  subgraph group_cursor["packages/cursor"]
    pkg_cursor_agent_gateway["cursor-agent-gateway"]
    pkg_cursor_mcp_prompt["cursor-mcp-prompt"]
    pkg_cursor_mcp_server["cursor-mcp-server"]
  end
  ...
  pkg_cursor_mcp_prompt --> pkg_invariants
  pkg_cursor_mcp_prompt --> pkg_tool_skill
  pkg_cursor_mcp_server --> pkg_agent
  pkg_cursor_mcp_server --> pkg_agent_default_model
  pkg_cursor_mcp_server --> pkg_invariants
  pkg_cursor_mcp_server --> pkg_llm
  pkg_cursor_mcp_server --> pkg_session
  pkg_cursor_mcp_server --> pkg_skill
  pkg_cursor_mcp_server --> pkg_tool_skill
  pkg_cursor_mcp_server --> pkg_tools
  ...
  pkg_cursor_agent_gateway --> pkg_client_connection
  pkg_cursor_agent_gateway --> pkg_cursor_mcp_server
  pkg_cursor_agent_gateway --> pkg_host_webserver
  pkg_cursor_agent_gateway --> pkg_invariants
  pkg_cursor_agent_gateway --> pkg_subprocess
  ...
  pkg_client_ui_cursor_agent --> pkg_client_connection
  pkg_client_ui_cursor_agent --> pkg_client_locale
  pkg_client_ui_cursor_agent --> pkg_client_runtime
  pkg_client_ui_cursor_agent --> pkg_client_ui_layout
  pkg_client_ui_cursor_agent --> pkg_client_ui_primitives
  pkg_client_ui_cursor_agent --> pkg_client_ui_settings
  pkg_client_ui_cursor_agent --> pkg_client_ui_slots
  pkg_client_ui_cursor_agent --> pkg_host_webserver
  pkg_client_ui_cursor_agent --> pkg_invariants
  ...
  pkg_client_ui_float_window --> pkg_client_connection
  pkg_client_ui_float_window --> pkg_client_locale
  pkg_client_ui_float_window --> pkg_client_runtime
  pkg_client_ui_float_window --> pkg_client_ui_layout
  pkg_client_ui_float_window --> pkg_client_ui_slots
  pkg_client_ui_float_window --> pkg_host_apiproxy
  pkg_client_ui_float_window --> pkg_invariants
  ...
  pkg_client_ui_overlay_desktop --> pkg_client_locale
  pkg_client_ui_overlay_desktop --> pkg_client_runtime
  pkg_client_ui_overlay_desktop --> pkg_client_ui_layout
  pkg_client_ui_overlay_desktop --> pkg_client_ui_slots
  pkg_client_ui_overlay_desktop --> pkg_invariants
  pkg_client_ui_overlay_shaped --> pkg_client_runtime
  pkg_client_ui_overlay_shaped --> pkg_client_ui_layout
  pkg_client_ui_overlay_shaped --> pkg_client_ui_slots
  pkg_client_ui_overlay_shaped --> pkg_invariants
  ...
  pkg_client_ui_television --> pkg_client_locale
  pkg_client_ui_television --> pkg_client_runtime
  pkg_client_ui_television --> pkg_client_ui_layout
  pkg_client_ui_television --> pkg_client_ui_slots
  pkg_client_ui_television --> pkg_invariants
  ...
  pkg_client_ui_flower_pot --> pkg_client_locale
  pkg_client_ui_flower_pot --> pkg_client_runtime
  pkg_client_ui_flower_pot --> pkg_client_ui_overlay_shaped
  pkg_client_ui_flower_pot --> pkg_client_ui_slots
  pkg_client_ui_flower_pot --> pkg_invariants
...
| [`cursor-mcp-prompt`](../packages/cursor/mcp-prompt) | `cursor` | [`invariants`](../packages/runtime-diagnostics/invariants), [`tool-skill`](../packages/skill/tool-skill) |
| [`cursor-mcp-server`](../packages/cursor/mcp-server) | `cursor` | [`agent`](../packages/core/agent), [`agent-default-model`](../packages/core/agent-default-model), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`skill`](../packages/skill/skill), [`tool-skill`](../packages/skill/tool-skill), [`tools`](../packages/core/tools) |
...
| [`cursor-agent-gateway`](../packages/cursor/agent-gateway) | `cursor` | [`client-connection`](../packages/client/connection), [`cursor-mcp-server`](../packages/cursor/mcp-server), [`host-webserver`](../packages/host/webserver), [`invariants`](../packages/runtime-diagnostics/invariants), [`subprocess`](../packages/subprocess/subprocess) |
...
| [`client-ui-cursor-agent`](../packages/client/ui-cursor-agent) | `client` | [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-layout`](../packages/client/ui-layout), [`client-ui-primitives`](../packages/client/ui-primitives), [`client-ui-settings`](../packages/client/ui-settings), [`client-ui-slots`](../packages/client/ui-slots), [`host-webserver`](../packages/host/webserver), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-float-window`](../packages/client/ui-float-window) | `client` | [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-layout`](../packages/client/ui-layout), [`client-ui-slots`](../packages/client/ui-slots), [`host-apiproxy`](../packages/host/apiproxy), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-overlay-desktop`](../packages/client/ui-overlay-desktop) | `client` | [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-layout`](../packages/client/ui-layout), [`client-ui-slots`](../packages/client/ui-slots), [`invariants`](../packages/runtime-diagnostics/invariants) |
| [`client-ui-overlay-shaped`](../packages/client/ui-overlay-shaped) | `client` | [`client-runtime`](../packages/client/runtime), [`client-ui-layout`](../packages/client/ui-layout), [`client-ui-slots`](../packages/client/ui-slots), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-television`](../packages/client/ui-television) | `client` | [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-layout`](../packages/client/ui-layout), [`client-ui-slots`](../packages/client/ui-slots), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-flower-pot`](../packages/client/ui-flower-pot) | `client` | [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-overlay-shaped`](../packages/client/ui-overlay-shaped), [`client-ui-slots`](../packages/client/ui-slots), [`invariants`](../packages/runtime-diagnostics/invariants) |
