 ...
 * with the real DeepSeek adapter and the real bash + dsh_todo_write tools. Lives
...
/** System prompt for the dsh_todo_write e2e: nudges the model to plan with the tool. */
export const TODO_SYSTEM_PROMPT = 'You are a coding agent. For multi-step work, '
  + 'use the dsh_todo_write tool to track a task list: send the WHOLE list each call, '
