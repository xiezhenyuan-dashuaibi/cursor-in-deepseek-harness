...
describe('documentAnchors', () => {
  ...
  it('keeps underscores the way GitHub does', () => {
    expect(githubSlug('Showcase: dsh_web_fetch')).toBe('showcase-dsh_web_fetch')
    expect(documentAnchors('## Showcase: dsh_web_fetch\n')).toEqual(new Set(['showcase-dsh_web_fetch']))
  })
