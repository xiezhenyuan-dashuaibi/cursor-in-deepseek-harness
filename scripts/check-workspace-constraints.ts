...
const packageFileExtras: Readonly<Record<string, readonly string[]>> = {
  ...
  '@deepseek-ai/dsh-cursor-mcp-server': ['cordis.patch.yml'],
  ...
  // Overlay CLI `--import` preload; Node (not tsx) loads this file in the child.
  '@deepseek-ai/dsh-cursor-agent-gateway': ['fence/*.mjs'],
}
