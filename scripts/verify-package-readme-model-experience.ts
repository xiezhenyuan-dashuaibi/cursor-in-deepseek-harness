...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-flower-pot': { kind: 'none', reason: 'Browser-only overlay-shaped.body occupant; registers nothing model-facing.' },
  'packages/client/ui-television': { kind: 'none', reason: 'Browser-only shell.overlay television fiber; registers nothing model-facing.' },
