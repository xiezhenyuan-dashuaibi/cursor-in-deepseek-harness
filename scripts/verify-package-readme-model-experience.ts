...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/typert/registry': { kind: 'none', reason: 'Runtime type registry; consumers (dsh_cordis_inspect_query, wire faces, gates) own any model-visible projection of registry contents.' },
  ...
  'packages/client/ui-cursor-agent': { kind: 'none', reason: 'Browser overlay for the official Cursor CLI TUI; the CLI owns its own model conversation.' },
  ...
  'packages/client/ui-dopamine-desk': { kind: 'none', reason: 'Browser-only overlay-desktop.body occupant; registers nothing model-facing.' },
  'packages/client/ui-black-hole': { kind: 'none', reason: 'Browser-only overlay-desktop.body occupant; registers nothing model-facing.' },
  'packages/client/ui-koi-pond': { kind: 'none', reason: 'Browser-only overlay-desktop.body occupant; registers nothing model-facing.' },
  'packages/client/ui-office-desk': { kind: 'none', reason: 'Browser-only overlay-desktop.body occupant; registers nothing model-facing.' },
  ...
  'packages/extensions/ui-cordis': { kind: 'indirect', reason: 'The definition card drives the host dynamic run/stop verbs that the model\'s dsh_cordis_run/dsh_cordis_stop tools also reach; the runner owns any model-visible effect.' },
  ...
  'packages/cursor/agent-gateway': { kind: 'none', reason: 'Host PTY WebSocket for the official Cursor CLI; that CLI owns its own model conversation.' },
