...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-petshop-store': { kind: 'none', reason: 'SQLite booking ledger overlay panel; registers nothing model-facing.' },
  'packages/client/ui-petshop-hub': { kind: 'none', reason: 'Booking-hub overlay panel and host RPC; registers nothing model-facing.' },
  'packages/client/ui-petshop': { kind: 'none', reason: 'Pet-grooming overlay homepage; registers nothing model-facing.' },
  'packages/client/ui-barber': { kind: 'none', reason: 'Browser-only overlay-card.body occupant; registers nothing model-facing.' },
